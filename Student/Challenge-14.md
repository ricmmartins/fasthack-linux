...
- Using wget to download a [sample application](https://github.com/ricmmartins/fasthack-linux/blob/main/Student/resources/sample-application.tar.gz) from a repository and uncompress the file.
