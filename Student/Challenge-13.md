...
In a server, especially those directly exposed to the Internet such as web servers are very common to receive thousands of authentication attempts. If you check your /var/log/auth.log file, you will attest to this.
...
Changing the default SSH port reduces number of such attacks, so for this exercise let's change from 22 to 2222. Remember to open port 2222 in your firewall or cloud security group.


- Install the package fail2ban
- Validate the configuration file /etc/fail2ban/jail.conf
- Make sure Fail2Ban is working as expected
