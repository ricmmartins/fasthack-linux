...
This challenge will give you an understanding over the Logical Volume Manager on Linux, and knowledge using the commands pvcreate, vgcreate, lvcreate, and more
...
- Check:
    ...
    - If the resize was reflected in the file system
...
5. Make sure both logical volumes were formatted as ext4 file system
...
- [LVM (Logical Volume Manager)](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/configuring_and_managing_logical_volumes/index)
