...
- Using wget to download a [sample application](https://github.com/ricmmartins/fasthack-linux/blob/main/Student/resources/simple-php-app.tar.gz?raw=true) from a repository and uncompress the file.
