# Desafio 04 - Conteúdo de arquivos - Guia do Coach 
...
3. Use cat para criar um arquivo chamado `count.log` com o seguinte conteúdo
...
4. Use cp para fazer um backup deste arquivo como `count.bkp`
...
6. Exiba cat-count.log, mas com todas as linhas em ordem reversa 
...
O -S ordena por tamanho de arquivo, do maior para o menor