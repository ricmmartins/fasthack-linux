...
- Extract the content of simple-php-app.tar.gz on your home directory
- Install nginx-core
- Install php8.3-fpm
- Configure Nginx
...
3. Make sure you have the packages nginx-core and php8.3-fpm installed
4. Show your Nginx running properly

## Hint

If you install Ubuntu 22.04 instead of Ubuntu 24.04, the version of the php-fpm which will be installed will be 8.1 instead of 8.3. Then make sure to configure the nginx config file properly.

## Learning Resources

- [How to Install PHP 8.3 With Nginx on Ubuntu](https://www.rosehosting.com/blog/how-to-install-php-8-3-with-nginx-on-ubuntu-24-04/)
- [How To Install Linux, Nginx, MySQL, PHP (LEMP stack) on Ubuntu](https://www.digitalocean.com/community/tutorials/how-to-install-linux-nginx-mysql-php-lemp-stack-on-ubuntu)
